...
| `deepseek-r1-0528` | `stop_spending_budget` | P12 not completed — do not escalate spend. |
...
| `gpt-oss-120b` | `stop_spending_budget` | P12 not completed — do not escalate spend. |
