#!/usr/bin/env python3
"""Write or verify the committed M07 unified benchmark pack manifest."""
...
def main() -> None:
    p = argparse.ArgumentParser(description="M07 unified pack manifest — write or check")
    ...
    if dumps_canonical(on_disk) != dumps_canonical(built):
        msg = (
            ...
            "Regenerate with: python scripts/generate_unified_core_m07_manifest.py --write"
        )
        raise SystemExit(msg)
    print(f"ok {out_path}")
