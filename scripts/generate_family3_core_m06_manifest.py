#!/usr/bin/env python3
"""Write or verify the committed Family 3 M06 canonical pack manifest."""
...
from lucid.packs.family3_core_m06 import (  # noqa: E402
    build_manifest_dict,
...
def main() -> None:
    p = argparse.ArgumentParser(description="Family 3 M06 pack manifest — write or check")
    ...
    if dumps_canonical(on_disk) != dumps_canonical(built):
        msg = (
            ...
            "Regenerate with: python scripts/generate_family3_core_m06_manifest.py --write"
        )
        raise SystemExit(msg)
    print(f"ok {out_path}")
