#!/usr/bin/env python3
"""Write or verify the committed Family 2 M05 canonical pack manifest."""
...
from lucid.packs.family2_core_m05 import (  # noqa: E402
    build_manifest_dict,
...
def main() -> None:
    p = argparse.ArgumentParser(description="Family 2 M05 pack manifest — write or check")
    ...
    if dumps_canonical(on_disk) != dumps_canonical(built):
        msg = (
            ...
            "Regenerate with: python scripts/generate_family2_core_m05_manifest.py --write"
        )
        raise SystemExit(msg)
    print(f"ok {out_path}")
